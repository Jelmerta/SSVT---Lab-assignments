...
-- Going backgwards
-- There should be at list one prime, produced by the sum of 101 primes, that is smaller than the one the software produces
-- Prerfom test to check all the sums of 101 primes, where every prime is smaller than the one produced by the previous algorithm
